...
void main() {
  ...
  setUp(() async {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
      ...
      (MethodCall call) async {
        ...
        if (call.method == 'captureInteractive' || call.method == 'captureFullScreen') {
  ...
  test('captureInteractive invokes native channel and returns path on success', () async {
  ...
  test('captureFullScreen invokes native channel and returns path on success', () async {
    mockCaptureResult = 'success';
