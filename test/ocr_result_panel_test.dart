...
void main() {
  testWidgets('shows the recognised text and both actions', (tester) async {
    await _pump(tester, result: _resultWith(['hello', 'world']));
  ...
  testWidgets('an empty result reports that nothing was found', (tester) async {
    await _pump(tester, result: OcrResult.empty);
  ...
  testWidgets(
      'an unavailable engine shows its reason, not the empty state',
      (tester) async {
  ...
  testWidgets('while loading it shows a spinner and no actions',
      (tester) async {
    await _pump(tester, result: OcrResult.empty, isLoading: true);
  ...
  testWidgets('a stale non-empty result cannot leak actions while loading',
      (tester) async {
    await _pump(tester, result: _resultWith(['stale']), isLoading: true);
  ...
  testWidgets('Insert hands back the plain text', (tester) async {
