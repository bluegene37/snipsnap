...
class ToolSidebar extends StatelessWidget {
  ...
  static const tools = [
    ToolSidebarItem(
      ...
      'Select',
      'Select & Cut region / annotations  (S/V)',
    ),
    ToolSidebarItem(
      CanvasTool.pen,
      Icons.edit_rounded,
      'Pen',
      'Freehand drawing pen  (P)',
    ),
    ToolSidebarItem(
      CanvasTool.line,
    ...
    ToolSidebarItem(
      ...
      'Shape',
      'Rectangle, ellipse, star & more  (U)',
    ),
    ToolSidebarItem(
      CanvasTool.highlight,
      Icons.brush_rounded,
      'Highlight',
      'Freehand highlighter brush  (H)',
    ),
    ToolSidebarItem(
      CanvasTool.text,
      Icons.text_fields_rounded,
      'Text',
      'Add text annotation label  (T)',
    ),
    ToolSidebarItem(
      CanvasTool.stepMarker,
      Icons.pin_drop_rounded,
      'Step',
      'Numbered step pins 1, 2, 3…  (N)',
    ),
    ToolSidebarItem(
      CanvasTool.blur,
      Icons.blur_on_rounded,
      'Blur',
      'Obfuscate / blur sensitive area  (B)',
    ),
    ToolSidebarItem(
      CanvasTool.ruler,
      Icons.straighten_rounded,
      'Ruler',
      'Measure pixel distance  (M)',
    ),
    ToolSidebarItem(
      CanvasTool.fill,
      Icons.format_color_fill_rounded,
      'Fill',
      'Paint bucket fill (connected / global)  (G)',
    ),
    ToolSidebarItem(
      CanvasTool.crop,
      Icons.crop_rounded,
      'Crop',
      'Crop & expand canvas bounds  (C)',
    ),
    ...
    ToolSidebarItem(
      ...
      'Extract',
      'Extract text from the image — drag a region or click for the whole image  (E)',
    ),
  ];
            ...
            Padding(
              ...
              child: Tooltip(
                message: isSidebarOpen
                    ? 'Hide Screenshots Gallery (Cmd+H)'
                    : 'Show Screenshots Gallery (Cmd+H)',
                child: Material(
                  color: Colors.transparent,
                  child: InkWell(
                    borderRadius: BorderRadius.circular(t.radius),
