...
void main() {
  final brainDir = '/Users/bluegene37/.gemini/antigravity/brain/b5bdca92-ec10-49dc-b1fe-2060e426c79d';

  final options = <String, String>{
    'logo_option_1_viewfinder_ss': '$brainDir/snipsnap_skeleton_icon_1787388570981.jpg',
    'logo_option_2_blueprint_ss': '$brainDir/snipsnap_skeleton_duo_1787388546212.jpg',
    'logo_option_3_monogram_s': '$brainDir/snipsnap_skeleton_logo_1787388521610.jpg',
  };
  ...
  for (final entry in options.entries) {
    ...
    final resized = img.copyResize(decoded, width: 1024, height: 1024, interpolation: img.Interpolation.cubic);
