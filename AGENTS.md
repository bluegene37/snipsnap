# Snipsnap Codebase Rules & Flutter Development Standards
...
## 5. Dart & MCP Tooling Integration

- Utilize `dart-mcp-server` tools (`analyze_files`, `get_runtime_errors`, `hot_reload`, `hot_restart`, `widget_inspector`) to inspect and diagnose the running application.
- Maintain zero analysis errors or warnings under strict typing (`strict-casts`, `strict-inference`, `strict-raw-types`).
